...
Notably, \Cref{chap:radar} introduces a novel \gls{fl} architecture for \gls{fids} that ensures the quality of incoming contributions in heterogeneous environments, with applications to the detections of malicious behaviors.
...
% TODO: Chapter 8 (chap:future) is not yet written and I'm concerned about not having the time to do it.
