\tikzstyle{leaf}=[draw, minimum size=1cm, node distance=1.5cm, circle]
\tikzstyle{c1}=[color=orange, thick, dash dot]
\tikzstyle{c2}=[color=violet, thick, dotted]
\tikzstyle{c3}=[color=teal, thick, densely dashed]
\begin{tikzpicture}[]
	\node[leaf, c1] (a) {a};
	...
	\node (ab) at ($(a)!0.5!(b)$) {};
	\node[above of=ab, node distance=1.1cm,label={[label distance=0, text=orange]175:0.1}] (ab1) {};
	
	\draw[c1] (a) |- (ab1.center);
	\draw[c1] (b) |- (ab1.center);
	
	\node (cd) at ($(c)!0.5!(d)$) {};
	\node[above of=cd, node distance=1.3cm,label={[label distance=
0, text=orange]175:0.3}] (cd1) {};
	...
	\node (bc) at ($(b)!0.5!(c)$) {};
	\node[above of=bc, node distance=1.7cm,label={[label distance=
0.4cm, text=orange]175:0.7}] (bc2) {};
	...
	\node[above of=bce, node distance=1.8cm,label={[label distance=
0.6cm, text=orange]175:0.8}] (bce3) {};
	...
	\node (gh) at ($(g)!0.5!(h)$) {};
	\node[above of=gh, node distance=1.2cm,label={[label distance=0cm, text=violet]175:$0.2$}] (gh1) {};
	
	\draw[c2] (g) |- (gh1.center);
	\draw[c2] (h) |- (gh1.center);	
	
	\node (fgh) at ($(f)!0.5!(gh)$) {};
	\node[above of=fgh, node distance=1.6cm,label={[label distance=5, text=violet]175:0.6}] (fgh1) {};
	...
	\node[above of=bcefgh, node distance=2.2cm,label={[label distance=0.9cm, text=black]175:1.2}] (bcefgh3) {};	
