...
By progressively penalizing the participants that propose models similar to each others, and that are thus suspected of being \emph{sybils} (see \Cref{sec:radar.problem,sec:assessment.threat}), it leaves room for participants issuing dissimilar models to be selected more often. 
