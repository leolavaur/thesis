...
\Cref{fig:sota.venues} shows the distribution of the publications in the most recurring venues.
...
But the most active country remains China, with a dozen institutions now amounting to a third of the publications in the field, as illustrated by \Cref{fig:sota.countries,fig:sota.affiliations}.
