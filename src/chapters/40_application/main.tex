\chapter{Performance and Limitations of FIDSs\label{chap:application}}
...
We will explore these limitations further in the next chapters: the impact of poisoning attacks in \Cref{chap:assessment,chap:radar}, and the impact of data heterogeneity in \Cref{chap:radar,chap:topologies}.