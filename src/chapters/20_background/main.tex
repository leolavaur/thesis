...
We start by laying out the foundations of \gls{ml} for intrusion detection in \Cref{sec:bg.ids}, followed by the implications of scaling up to \glspl{cids} in \Cref{sec:bg.collab}, enumerating along the way the challenges that motivate the use of \gls{fl}.
