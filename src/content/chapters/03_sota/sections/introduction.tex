...
\boitemagique{Contributions of this chapter}{
  \begin{itemize}[\bullet]
    \item The first (at the time of its publication) \gls{slr} on the use of \gls{fl} for \gls{ids}, including qualitative and quantitative analyses of the literature.
    ...
    \item The main challenges and opportunities in the field, and a set of research directions to address them.
  \end{itemize}
}